let employees = [
    ...
    { name: "Michell jack", department: "Editing" },
    { name: "Joseph Jane", department: "Editing" }
];
...
// count the frequency of the department
const employee = employees.reduce((acc, cur) => {
    if (acc[cur.department]) {
        acc[cur.department]++;
    }
    else {
        acc[cur.department] = 1;
    }
    return acc;
})
